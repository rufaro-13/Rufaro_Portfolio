...
function Footer() {
  ...
  <section className="bg-cover bg-center bg-no-repeat   bg-blend-multiply pt-12">      
    <footer class="bg-bluetheme   shadow dark:bg-gray-900 ">
        <div class="w-full max-w-screen-xl mx-auto py-5 md:py-5">
            <div class="sm:flex sm:items-center sm:justify-between">
                ...
                <ul class="flex flex-wrap text-lg text-sm  pt-4 text-base font-medium text-white sm:mb-0 dark:text-gray-400">
                    ...
                    <Link to='/services'> Projects</Link><br/>
            ...
            <hr class="my-6 border-yellowtheme sm:mx-auto dark:border-gray-700 lg:my-2" />
