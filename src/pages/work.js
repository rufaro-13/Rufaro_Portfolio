...
<div className="md:flex grid lg:grid-cols-6 sm:items-center sm:justify-between pt-4 md:px-8 px-5">

<div className='web items-center justify-center'>
    <img src={ortu}className="workimage rounded-3xl border-solid border-8 border-black md:mx-5 mx-2"alt="Ortu Logo" />
</div>
<div className='phone'>
    <img src={veemu1}className="workimage1 rounded-3xl border-solid border-8 border-black  mx-5" alt="Ortu Logo" />
</div>
...
<div className="md:flex grid lg:grid-col-1 sm:items-center sm:justify-between pt-4 md:px-8 px-5">

    <div className='web items-center justify-center'>
        <img src={stain}className="workimage rounded-3xl border-solid border-8 border-black md:mx-5 mx-2"alt="Ortu Logo" />
    </div>
    <div className='phone'>
        <img src={stain1}className="workimage1 rounded-3xl border-solid border-8 border-black  mx-5" alt="Ortu Logo" />
    </div>
...
<div className="md:flex grid lg:grid-col-1 sm:items-center sm:justify-between pt-4 md:px-8 px-5">
    ...
    <div className='web items-center justify-center'>
        <img src={veemu}className="workimage rounded-3xl border-solid border-8 border-black md:mx-5 mx-2"alt="Ortu Logo" />
    </div>
    <div className='phone'>
        <img src={veemu1}className="workimage1 rounded-3xl border-solid border-8 border-black  mx-5" alt="Ortu Logo" />
    </div>
...
<div className="md:flex grid lg:grid-col-1 sm:items-center sm:justify-between pt-4 md:px-8 px-5">
    ...
    <div className='web items-center justify-center'>
        <img src={continued}className="workimage rounded-3xl border-solid border-8 border-black  md:mx-5 mx-2" alt="Ortu Logo" />
    </div>
    <div className='phone'>
        <img src={cont}className="workimage1 rounded-3xl border-solid border-8 border-black  mx-5" alt="Ortu Logo" />
    </div>
...
<div className="md:flex grid lg:grid-col-1 sm:items-center sm:justify-between pt-4 md:px-8 px-5">
    ...
    <div className='web'>
        <img src={gg}className="workimage rounded-3xl border-solid border-8 border-black md:mx-5 mx-2" alt="Ortu Logo" />
    </div>
